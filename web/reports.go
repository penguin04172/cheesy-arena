...
func (web *Web) rankingsPdfReportHandler(w http.ResponseWriter, r *http.Request) {
	...
	colWidths := map[string]float64{"Rank": 13, "Team": 22, "RP": 23, "Coop": 22, "Match": 22, "Stage": 22, "Auto": 25,
	...
	for _, ranking := range rankings {
		...
		pdf.CellFormat(colWidths["Coop"], rowHeight, strconv.Itoa(ranking.CoopertitionPoints), "1", 0, "C", true, 0, "")
		pdf.CellFormat(colWidths["Match"], rowHeight, strconv.Itoa(ranking.MatchPoints), "1", 0, "C", false, 0, "")
		pdf.CellFormat(
			colWidths["Stage"], rowHeight, strconv.Itoa(ranking.StagePoints), "1", 0, "C", false, 0, "",
		)
