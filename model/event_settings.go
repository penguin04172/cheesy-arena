...
type EventSettings struct {
	...
	CoralBonusLevelThresholdWithoutCoop int
	CoralBonusLevelThresholdWithCoop    int
...
func (database *Database) GetEventSettings() (*EventSettings, error) {
	...
	eventSettings := EventSettings{
		...
		CoralBonusLevelThresholdWithoutCoop: game.CoralBonusLevelThresholdWithoutCoop,
		CoralBonusLevelThresholdWithCoop:    game.CoralBonusLevelThresholdWithCoop,
